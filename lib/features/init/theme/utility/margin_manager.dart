...
class ProjectMarginUtility {
  final EdgeInsets normalHorizontalMargin = const EdgeInsets.symmetric(horizontal: 10);
  ...
  final EdgeInsets normalOnlyTopMargin = const EdgeInsets.only(top: 10);
}
