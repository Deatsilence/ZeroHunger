  ...
  void initState() {
    ...
    checkUserAvailable().then((avaliable) async {
      if (avaliable) {
        ...
        await NavigatorManager.instance.pushToNamedAndRemoveUntil(route: NavigateRoutes.home.withParaph);
        ...
        await NavigatorManager.instance.pushToNamedAndRemoveUntil(route: NavigateRoutes.login.withParaph);
      }
    });
  }
